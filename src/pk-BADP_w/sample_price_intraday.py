...
day_data = loadmat(sample_price_day_inputs_path)
# %%

# %%

intra_data = loadmat(sample_price_intraday_inputs_path)

# %%
# sample_price_intraday([Wt_day,P_day],P_intraday,t,Season)

# Load required data
Wt_day = intra_data['Wt_day'][0]
P_day = intra_data['P_day'][0]
P_intraday = intra_data['P_intraday'][0]
t = 1
Season = 'Summer'
#%%

a, b = sample_price_intraday(np.concatenate([Wt_day, P_day]), P_intraday, t, Season)
# %%

a == intra_data['mu_intraday']

# %%

b == intra_data['cor_intraday']
