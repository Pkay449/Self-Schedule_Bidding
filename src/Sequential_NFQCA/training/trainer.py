...
from src.config import TrainingParams, SimulationParams
import optax
from functools import partial


class NFQCA:
    def __init__(self, sim_params: SimulationParams, training_params: TrainingParams, rng_key):
    ...
    def get_lb_id(self):
        ...
        lb_id = jnp.concatenate(
            [
                ...
                -1e8 * jnp.ones(96),  # unbounded (lower bound ~ -inf)
    ...
    def get_ub_id(self):
        ...
        ub_id = jnp.concatenate(
            [
                ...
                1e8 * jnp.ones(96 * 7),  # unbounded (upper bound ~ inf)
    ...
    def update_q_id(self, s_id, a_id, r_id, s_da_next):
        ...
        def loss_fn(params):
            ...
            next_da_actions = self.policy_da_model.apply(self.policy_da_params, s_da_next)
            q_da_values = self.q_da_model.apply(self.q_da_target_params, s_da_next, next_da_actions)
    ...
    def update_q_da(self, s_da, a_da, r_da, s_id_next):
        ...
        def loss_fn(params):
            ...
            next_id_actions = self.policy_id_model.apply(self.policy_id_params, s_id_next)
            q_id_values = self.q_id_model.apply(self.q_id_target_params, s_id_next, next_id_actions)
    ...
    def update_policy_da(self, s_da):
        ...
        updates, self.policy_da_opt_state = self.policy_da_opt.update(grads, self.policy_da_opt_state)
    ...
    def update_policy_id(self, s_id):
        ...
        updates, self.policy_id_opt_state = self.policy_id_opt.update(grads, self.policy_id_opt_state)
    ...
    def update_policy_id_with_penalty(
        ...
        def loss_fn(params):
            ...
            Ax = jnp.einsum("bca,ba->bc", A_total, a_id)  # Shape: (batch_size, num_constraints)
