function [ mu_P, cov_P ] = clean_sample_price_intraday( Pt_day,Pt_intraday,t,Season)
...
% t= aktuelle Stufe ==>samples f�r Stufe t+1
...
load(fullfile('Data', strcat('cov_intraday_', Season, '.mat')));
